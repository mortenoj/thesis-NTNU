...
Furthermore, as the thesis focuses on \acrfull{ml}, it is recommended that the reader has an initial understanding of \acrshort{ml} related, or statistical, concepts and methods.
